...
def identify_morning_star(tickerData):
    ...
    tickerData['Morning Star'] = downtrend['Downtrend'] & first_candle_bearish & first_candle_not_doji & second_candle_doji & gap_down_first_second & third_candle_bullish & third_candle_not_doji & gap_up_second_third
