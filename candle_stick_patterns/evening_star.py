...
def identify_evening_star(tickerData):
    ...
    tickerData['Evening Star'] = tickerData['Uptrend'] & first_candle_bullish & first_candle_not_doji & second_candle_doji & gap_up_first_second & third_candle_bearish & third_candle_not_doji & gap_down_second_third
    return tickerData
