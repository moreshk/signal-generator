...
app.layout = html.Div(
    [
        dcc.Interval(id='interval-component', interval=60*60000, n_intervals=0),  # 1 minute intervals
...
def update_graph(n):
    ...
    # Download 15 minute data for past 15 days 
    nse = yf.Ticker("^NSEI")
    hist = nse.history(period="15d", interval="60m")
