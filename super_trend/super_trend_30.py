...
app.layout = html.Div(
    [
        dcc.Interval(id='interval-component', interval=30*60000, n_intervals=0),  # 1 minute intervals
...
def update_graph(n):
    ...
    # Download 15 minute data for past 10 days 
    nse = yf.Ticker("^NSEI")
    hist = nse.history(period="10d", interval="30m")
